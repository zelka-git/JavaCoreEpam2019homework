...
import homework20191220.storage.IdGenerator;
import homework20191220.storage.Storage;

import java.util.Arrays;

import static homework20191220.storage.Storage.cargoArray;
import static homework20191220.storage.Storage.sizeCargo;
...
public class CargoArrayRepoImpl implements CargoRepo {
    ...
    public boolean deleteById(long id) {
        for (int i = 0; i < sizeCargo; i++) {
            try {
                if (cargoArray[i].getId().equals(id)) {
