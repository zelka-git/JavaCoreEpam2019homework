...
import ru.epam.javacore.homework20191230.cargo.domain.*;
...
public class PrintToTextFile implements StoragePrint {
    private static final String FILE_PATH = "/ru/epam/avacore/homework20191230/print_out.txt";
    private static final String DIR_PATH = "/ru/epam/javacore/homework20191230/";
