...
public final class StorageInitorFactory {
    ...
    private static String pathTxt = "/ru/epam/javacore/homework20191230/inputData.txt";
    private static String pathXml = "/ru/epam/javacore/homework20191230/input_xml.xml";
