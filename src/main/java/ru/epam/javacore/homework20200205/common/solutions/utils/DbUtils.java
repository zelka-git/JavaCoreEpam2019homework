...
import ru.epam.javacore.homework20200205.common.solutions.functionaliterfaces.JdbcBiConsumer;
import ru.epam.javacore.homework20200205.common.solutions.functionaliterfaces.JdbcConsumer;
import ru.epam.javacore.homework20200205.common.solutions.functionaliterfaces.JdbcFunction;
...
public class DbUtils {
    ...
    public static <T> List<T> select(String sql, JdbcConsumer<PreparedStatement> psConsumer, JdbcFunction<ResultSet, T> rsConverter) {
