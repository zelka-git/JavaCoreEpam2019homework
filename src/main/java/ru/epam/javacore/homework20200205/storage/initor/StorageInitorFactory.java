...
import ru.epam.javacore.homework20200205.storage.initor.InMemoryStorageInitor;
import ru.epam.javacore.homework20200205.storage.initor.InitStorageType;
import ru.epam.javacore.homework20200205.storage.initor.StorageInitor;
import ru.epam.javacore.homework20200205.storage.initor.fileinitor.TextFileDataInitor;
import ru.epam.javacore.homework20200205.storage.initor.fileinitor.xml.dom.XmlDomFileDataInitor;
import ru.epam.javacore.homework20200205.storage.initor.fileinitor.XmlSaxFileDataInitor;
import ru.epam.javacore.homework20200205.storage.initor.fileinitor.XmlSaxFileDataInitorMultithreading;
import ru.epam.javacore.homework20200205.storage.initor.multithread.MultiThreadStorageInitor;
...
public final class StorageInitorFactory {
    ...
    private static String pathTxt = "/ru/epam/javacore/homework20200205/inputData.txt";
    private static String pathXml = "/ru/epam/javacore/homework20200205/input_xml.xml";
