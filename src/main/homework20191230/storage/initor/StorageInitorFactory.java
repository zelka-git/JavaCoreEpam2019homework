package main.homework20191230.storage.initor;
...
public final class StorageInitorFactory {
    ...
    private static String pathTxt = "/main/homework20191230/inputData.txt";
    private static String pathXml = "/main/homework20191230/input_xml.xml";
