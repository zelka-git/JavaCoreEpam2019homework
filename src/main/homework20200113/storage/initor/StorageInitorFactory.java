package main.homework20200113.storage.initor;
...
public final class StorageInitorFactory {
    ...
    private static String pathTxt = "/main/homework20200113/inputData.txt";
    private static String pathXml = "/main/homework20200113/input_xml.xml";
