...
import static homework20191225.storage.Storage.cargoArray;
import static homework20191225.storage.Storage.sizeCargo;
...
public class CargoArrayRepoImpl implements CargoRepo {
    ...
    public List<Cargo> getAllSortedItems(TypeSortCargo typeSortCargo) {
        ...
        switch (typeSortCargo) {
            case NAME:
                Arrays.sort(sortCargoArray, homework20191225.cargo.repo.CargoComparators.COMPARE_BY_NAME);
                break;
            case WEIGHT:
                Arrays.sort(sortCargoArray, homework20191225.cargo.repo.CargoComparators.COMPARE_BY_WEIGHT);
                break;
            case NAME_WEIGHT:
                Arrays.sort(sortCargoArray, homework20191225.cargo.repo.CargoComparators.COMPARE_BY_NAME.thenComparing(homework20191225.cargo.repo.CargoComparators.COMPARE_BY_WEIGHT));
                break;
            default:
                Arrays.sort(sortCargoArray, homework20191225.cargo.repo.CargoComparators.COMPARE_BY_WEIGHT.thenComparing(CargoComparators.COMPARE_BY_NAME));
        }
